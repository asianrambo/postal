...
if(function_exists('vc_map')){
   ...
   "params" => array( 
      ...
      array(
         ...
         "holder" => "div",
         "class" => "",
         "heading" => esc_html__("Latitude,Longitude 1", 'cloudme'),
         "param_name" => "latlong1",
         "value" => "",
      ...
      array(
         ...
         "holder" => "div",
         "class" => "",
         "heading" => esc_html__("Infomation 1", 'cloudme'),
         "param_name" => "info1",
         "value" => "",
         "description" => esc_html__("Description about location 1", 'cloudme')
      ),
      array(
         "type" => "textfield",
         "holder" => "div",
         "class" => "",
         "heading" => esc_html__("Latitude,Longitude 2", 'cloudme'),
         "param_name" => "latlong2",
         "value" => "",
         "description" => esc_html__("PPlease enter http://www.latlong.net/ Latitude,Longitude google map. Example: 39.98978,-83.00632.", 'cloudme')
      ),
      array(
         "type" => "textarea",
         "holder" => "div",
         "class" => "",
         "heading" => esc_html__("Infomation 2", 'cloudme'),
         "param_name" => "info2",
         "value" => "",
         "description" => esc_html__("Description about location 2", 'cloudme')
      ),
      array(
         "type" => "textfield",
         "holder" => "div",
         "class" => "",
         "heading" => esc_html__("Latitude,Longitude 3", 'cloudme'),
         "param_name" => "latlong3",
         "value" => "",
         "description" => esc_html__("Please enter http://www.latlong.net/ Latitude,Longitude google map. Example: 39.98978,-83.00632.", 'cloudme')
      ),
      array(
         ...
         "holder" => "div",
         "class" => "",
         "heading" => esc_html__("Infomation 3", 'cloudme'),
         "param_name" => "info3",
         "value" => "",
         "description" => esc_html__("Description about location 3", 'cloudme')
      ),
      array(
         "type" => "textfield",
         "holder" => "div",
