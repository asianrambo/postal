...
class DomainAvailability {
	...
	public function is_available($domain) {
		...
		$whois_arr = array(
			...
			"asnau"=>  array("whois.audns.net.au", "No Data Found"),
			"comau"=>  array("whois.audns.net.au", "No Data Found"),
			"eduau"=>  array("whois.audns.net.au", "No Data Found"),
			"orgau"=>  array("whois.audns.net.au", "No Data Found"),
			"netau"=>  array("whois.audns.net.au", "No Data Found"),
			"idau"=>  array("whois.audns.net.au", "No Data Found"),
