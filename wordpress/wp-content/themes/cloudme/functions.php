...
function cloudme_theme_scripts_styles() {
  ...
  wp_enqueue_script("cloudme-maps-js", "$protocol://maps.googleapis.com/maps/api/js?v=3.exp&hl=en&sensor=true",array('jquery'),false,true);
  ...
  wp_enqueue_script("cloudme-retina", get_template_directory_uri()."/js/vendor/retina.min.js",array('jquery'),false,true);    
...
if(isset($_POST['domain']))
{
    ...
    if(strlen($domain) > 0)
    {
        ...
        $custom_found_result_text = '<i class="fa fa-check"></i>  Congratulations! <b>'.$domain.'</b> is available!';
        $custom_not_found_result_text = '<i class="fa fa-times"></i>  Sorry! <b>'.$domain.'</b> is already taken!';
...
vc_add_param('vc_column',array(
                              "type" => "dropdown",
                              "heading" => esc_html__('Animation', 'cloudme'),
                              "param_name" => "animate",
                              "value" => array(
                                esc_html__('None', 'cloudme') => 'none',
                                esc_html__('fade In', 'cloudme') => 'fadein',
                                esc_html__('fade InUp', 'cloudme') => 'fadeinup',  
                                esc_html__('fade InDown', 'cloudme') => 'fadeindown',                                 
                                esc_html__('fade InLeft', 'cloudme') => 'fadeinleft',
                                esc_html__('fade InRight', 'cloudme') => 'fadeinright',
                                esc_html__('zoom In', 'cloudme') => 'zoomin',                                                                             
                               ),     
                            ) 
    );
...
vc_add_param('vc_column',array(
                              "type" => "textfield",
                              "heading" => esc_html__('Animation Time', 'cloudme'),
                              "param_name" => "time",
                              "value" => "",
                              'dependency'  => array( 'element' => 'animate', 'value' => array( 'fadein', 'fadeinup', 'fadeindown','fadeinleft', 'fadeinright', 'zoomin' ) ),
                              "description" => esc_html__("Input time show column. Example: 0.6", "cloudme"),
                            ) 
    );
